...
public class ParallaxBackground extends Component {
    ...
    public void draw(Graphics2D g2) {
        if(followGround) {
            g2.drawImage(this.sprite.image, (int)this.gameObject.transform.position.x, (int)(this.gameObject.transform.position.y - Window.getWindow().getCurrentScene().camera.position.y), width,height, null);
        } else {
